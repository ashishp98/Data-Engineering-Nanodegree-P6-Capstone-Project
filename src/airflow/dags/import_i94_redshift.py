...
DATABASE_CONNECTION_ID = "udacity-capstone-redshift"
DATA_LAKE_PATH = "s3://udacity-capstone"
AWS_CREDENTIALS_ID = "aws_credentials"

default_arguments = {
    'owner': 'Udacity DE ND',
    'description': 'Importing immigration staging data to various supporting dimension tables and fact table',
